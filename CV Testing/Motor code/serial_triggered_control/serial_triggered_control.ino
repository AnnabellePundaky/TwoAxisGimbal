...
void setup() 
{
  ...
  Serial2.begin(9600, SERIAL_8N1, RX2, TX2); // Initialize Serial2 for communication on pins 16 and 17
...
if (Serial2.available()) {
    ...
    if(in_num == CCW_X_FLAG) { Serial.println("Move Horizontal-axis CCW"); }
    else if (in_num == CW_X_FLAG) { Serial.println("Move Horizontal-axis CW"); }
    else if (in_num == CCW_Y_FLAG) { Serial.println("Move Vertical-axis CCW"); }
    else if (in_num == CW_Y_FLAG) { Serial.println("Move Vertical-axis CW"); }
