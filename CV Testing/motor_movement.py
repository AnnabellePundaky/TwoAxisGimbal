...
class Serial_Wrapper:
	...
	def send_data(self, data, expect_confirmation=False, print_confirmation=True):
		self.ser.write(data)
		print('\t||| Sent "' + str(data) + '" over serial.')  # Make sure this line is active
...
class Serial_Motor_Control:
	def __init__(self, device='/dev/serial0', baud=9600, cw_x_flag='1', ccw_x_flag='2', cw_y_flag='3', ccw_y_flag='4'):
